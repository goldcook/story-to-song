...
- 同时分析失落、紧张、温柔、怀念、希望、平静、行动感、空间感与孤独感，并理解否定、转折和结尾走向
- 让每个情绪维度分别影响大调/小调、BPM、旋律轮廓、音区、节奏密度、声场和乐器编制
- 在原创和声、动机、发展方式、配器、终止式与织体组合中，选择最贴合故事情绪的一版
- 从故事意象中组织歌名、主歌、副歌、桥段与尾声
- 使用浏览器 Web Audio API 编排一段约 26 秒、有起承转合的纯器乐 Demo
- 以内置的真实钢琴、原声吉他、大提琴、单簧管与手工打击乐采样承担全部声部；音源失败时宁可留白，也不回退到电子振荡器
...
音乐选择层使用透明、可审计的作曲规则，不复制参考歌曲的歌词、录音或旋律；方法与未来参考素材的许可边界见 [research/README.md](research/README.md)。
